...
//                      .fill(.ultraThinMaterial) // clouds/rain
                      .fill(.peachPuff.opacity(0.45)) //day
//                      .fill(.thinMaterial) //night
...
//                                              Text(date, formatter: DateFormatter.timeWithAMPM)
                                                  .font(.caption)
                                                  .foregroundColor(.white.opacity(0.8))
                                          }
                                      }
...
//#Preview {
//    HourlyForecastView(forecast: HourlyForecastResponse.exampleHourly)
//}
