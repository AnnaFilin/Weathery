...
let weatherCodes: [Int: WeatherCode] = [
    ...
    2100: WeatherCode(code: 2100, description: "Light Fog", iconDay: "21000_light_fog_large", iconNight: "21001_light_fog_large"),
    4000: WeatherCode(code: 4000, description: "Drizzle", iconDay: "40000_drizzle_large", iconNight: "40001_drizzle_large"),
    4001: WeatherCode(code: 4001, description: "Rain", iconDay: "40010_rain_large", iconNight: "40011_rain_large"),
